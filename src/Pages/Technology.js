...
const Technology = () => {
    ...
    return (
        <div className="technology min-h-screen md:h-auto lg:h-screen w-screen bg-cover flex justify-start flex-col md:flex-col-reverse text-center  lg:text-left lg:justify-center text-white max-w-screen-desktop mx-auto loadingAnimation">
            <div className="w-full mx-auto mt-24 max-w-screen-desktop fadeAnimation">
                ...
                <div className="md:flex md:flex-col lg:flex-row-reverse lg:items-center  md:mb-0">
                    ...
                    <div className="mx-auto lg:mx-0  flex flex-col-reverse  mb-20 md:mb-24 lg:flex-row-reverse lg:items-center  fadeAnimation">
                        <div className="mx-auto md:mt-5 lg:h-full lg:mt-0 lg:w-[470px] lg:mr-auto w-4/5 md:max-w-[458px]">
